...
Public Class Employee2
    ...
    Private Sub Phone_KeyPress(sender As Object, e As KeyPressEventArgs)
    ...
    Private Sub Salary_KeyPress(sender As Object, e As KeyPressEventArgs)
        If (Asc(e.KeyChar) >= 48 And Asc(e.KeyChar) <= 57) Or Asc(e.KeyChar) = 8 Then
            e.Handled = False
        Else
            e.Handled = True
    ...
    Private Sub Insert_Click_1(sender As Object, e As EventArgs) Handles Insert.Click
